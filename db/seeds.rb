...
shopping3 = ShoppingCartItem.create(user_id: e.id, product_id: product2.id, quantity: 1);
shopping4 = ShoppingCartItem.create(user_id: e.id, product_id: product4.id, quantity: 2);
shopping3 = ShoppingCartItem.create(user_id: a.id, product_id: product9.id, quantity: 1);
shopping4 = ShoppingCartItem.create(user_id: a.id, product_id: product10.id, quantity: 2);
