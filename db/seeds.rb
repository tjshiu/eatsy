...
product1= Product.create(product_name: "Mama's Favorite Chocolate Cake",
  ...
  cost: 20.00,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522981626/triple_chocolate_cake.jpg",
  user_id: d.id
)
product2 = Product.create(product_name: 'Raspberry Mint Cake',
  ...
  cost: 20.00,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522981616/mint_rasberry_cake.jpg",
  user_id: d.id
)
...
product6 = Product.create(product_name: 'Raspberry Popsicles',
  ...
  cost: 5.99,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522981610/rasberry_popscicles.jpg",
  user_id: e.id
)
product7 = Product.create(product_name: 'Nutty-Dark-Chocolate Popsicles',
  ...
  cost: 7.99,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522981611/nutty_chocolatey_popscicles.jpg",
  user_id: e.id
)
product8 = Product.create(product_name: 'Fresh Citrus',
  ...
  cost: 24.99,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522981848/citrus.jpg",
  user_id: a.id
)
product9 = Product.create(product_name: 'Hummus and Snacks',
  ...
  cost: 7.99,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522965915/hummus_and_other_snacks.jpg",
  user_id: b.id
)
product10 = Product.create(product_name: 'Beef Tacos',
  ...
  cost: 20.99,
  image_url: "http://res.cloudinary.com/dwanjkcku/image/upload/c_scale,w_700/v1522965918/beef_tacos.jpg",
  user_id: c.id
)
